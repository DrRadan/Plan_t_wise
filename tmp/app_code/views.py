...
def results():
    ...
    ClustLoc = pd.read_csv('/Users/nikiathanasiadou/Insight_NYC_Trees/AWS/app_code/data/ClusterCoords.txt', sep="\t") #The tree coords and the cluster they belong
    t_num = pd.read_csv('/Users/nikiathanasiadou/Insight_NYC_Trees/AWS/app_code/data/Numbers_tab.csv')  #Number of trees
    t_surv = pd.read_csv('/Users/nikiathanasiadou/Insight_NYC_Trees/AWS/app_code/data/Survival_tab.csv')  #Probability of survival
    t_name = pd.read_csv('/Users/nikiathanasiadou/Insight_NYC_Trees/AWS/app_code/data/Tree_names_tab.csv')  #Match of latin and common names
